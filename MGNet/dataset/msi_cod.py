...
class MSICOD_TestDataset(_BaseSODDataset):
    ...
    def __getitem__(self, index):
        ...
        images = ms_resize(image, scales=(0.7,1.0, 1.2), base_h=base_h, base_w=base_w)
        image_0_7 = torch.from_numpy(images[0]).permute(2, 0, 1)
        image_1_0 = torch.from_numpy(images[1]).permute(2, 0, 1)
        image_1_2 = torch.from_numpy(images[2]).permute(2, 0, 1)
