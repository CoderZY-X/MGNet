...
def parse_config():
    ...
    parser.add_argument("--config", default="/root/autodl-tmp/MGNet/configs/MGNet/glass-MGNet.py", type=str)
    parser.add_argument("--datasets-info", default="/root/autodl-tmp/MGNet/configs/_base_/dataset/dataset_configs.json", type=str)
